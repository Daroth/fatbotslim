...
class Helper(BasePlugin):
    ...
    def showNoticeHelp(self, user, message):
        plugins = [p for p in self.client.pman.plugins if p.noticeHelp]
        if len(plugins) != 0:
