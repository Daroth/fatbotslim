...
class Config(object):
    ...
    rules = {
        'server': {'mandatory': True, 'type': str},
        'host': {'mandatory': True, 'type': str},
        'nickname': {'mandatory': True, 'type': str},
        'channels': {'mandatory': True, 'type': list},
        'srv_pass': {'mandatory': False, 'type': str, 'default': ''},
        ...
        'versionName': {'mandatory': False, 'type': str, 'default': NAME},
        'versionNum': {'mandatory': False, 'type': str, 'default': VERSION},
    }
    ...
    def check(self):
        ...
        for opt, rule in self.rules.items():
            ...
            if type(getattr(self, opt)) is not rule['type']:
